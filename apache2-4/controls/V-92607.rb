...
"
	...
	describe command('grep -i "CustomLog" /etc/httpd/conf/*.conf /etc/httpd/conf.d/*.conf | grep -v "#"') do
		its('stdout') { should include ('CustomLog “log/access_log” combined', 'CustomLog “log/access_log” common',
			'CustomLog “Log/access_log” combined', 'CustomLog “Log/access_log” common') }
	end
