...
Unused and unnecessary DBMS components increase the attack vector for the DBMS by introducing additional targets for attack. By minimizing the services and applications installed on the system, the number of potential vulnerabilities is reduced.false"
	impact 0.5
	tag "check": "Run this query to produce a list of components and features installed with the database:
...
Oracle Database Vault"
	tag "fix": "If any components are required for operation of applications that will be accessing the DBMS, include them in the system documentation.
