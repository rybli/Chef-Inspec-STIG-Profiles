...
control "V-52213" do
	...
	desc "In support of Audit Review, Analysis, and Reporting requirements, audit reduction is a technique used to reduce the volume of audit records in order to facilitate a manual review.  
...
The lack of reporting tools for audit reduction can require the DBA, or others responsible for reviewing audit logs, to sort through large amounts of data in order to find relevant records.  This can cause important audit records to be missed.false"
	impact 0.5
	tag "check": "Verify that audit reduction capabilities are in place for the Oracle audit tables.  Since Oracle has no reduction capability per se, a third-party tool or in-house-developed software must be in place to provide this functionality.  This must include the ability to report on the excluded audit data.

If this capability has not been implemented, this is a finding."
	tag "fix": "Deploy software capable of performing audit table reduction and of reporting on the excluded audit data."
