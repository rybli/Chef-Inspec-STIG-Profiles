...
control 'V-77201' do
  ...
  desc 'check', "This is NA prior to v1709 of Windows 10.
      ...
      only those with a required status are listed here. If the PowerShell command does not
  ...
  if input('sensitive_system') == 'true' || nil
    ...
    describe 'This STIG does not apply to Prior Versions before 1709.' do
      ...
      describe 'Override Payload ExportAddressFilter, Override Payload ExportAddressFilterPlus, Override ImportAddressFilter, Override EnableRopStackPivot, Override EnableRopCallerCheck, and Override EnableRopSimExec are required to be false onAdobe Reader' do
       subject { payload }
