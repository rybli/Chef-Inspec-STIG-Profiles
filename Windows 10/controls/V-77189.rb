...
control 'V-77189' do
  ...
  if input('sensitive_system') == 'true' || nil
    ...
    dep = json( command: 'Get-ProcessMitigation -Name Acrobat.exe | Select DEP | ConvertTo-Json').params
     ...
     describe 'Override PayloadExportAddressFilter, Override Payload ExportAddressFilterPlus, Override ImportAddressFilter, Override EnableRopStackPivot, Override EnableRopCallerCheck, and Override EnableRopSimExec are required to be false on Acrobat' do
       subject { payload }
