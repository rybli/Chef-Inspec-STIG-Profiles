...
control 'V-77255' do
  ...
  if input('sensitive_system') == 'true' || nil
   ...
   payload = json( command: 'Get-ProcessMitigation -Name VISIO.EXE | Select Payload | ConvertTo-Json').params
       describe 'Override Payload ExportAddressFilter, Override Payload ExportAddressFilterPlus, Override ImportAddressFilter, Override EnableRopStackPivot, Override EnableRopCallerCheck, and Override EnableRopSimExec are required to be false on Microsoft Office Visio' do
        subject { payload }
